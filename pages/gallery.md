...
<div class="gallery-grid">
  <a href="/gallery/file_organize" class="gallery-item">
    <img src="/assets/images/gallery/file_organize.png" alt="整理文件">
    <h3>文件整理</h3>
    <p>整理文件，清理过时或重复的内容，自动按类型归档……所有你嫌麻烦的事情，都可以试一下让 OpenDesk 来完成。</p>
  </a>
  <a href="/gallery/file_transfer" class="gallery-item">
    <img src="/assets/images/gallery/file_transfer.png" alt="远程文件查找">
    <h3>远程文件查找</h3>
